...
const ScrollToTopButton = () => {
  ...
  return (
    <button
      className={`bg-yellow-500 hover:bg-yellow-400 border-none rounded-full cursor-pointer w-8 h-8 fixed bottom-8 md:right-12 right-8 transition-all duration-200 ${
